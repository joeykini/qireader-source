define(["exports"], (function(t) { 
    ...
    class o {
        ...
        findMatchingRoute({ url: t, sameOrigin: e, request: s, event: n }) {
            ...
            for (const r of i) {
                ...
                if (o) return i = o, (Array.isArray(i) && 0 === i.length || o.constructor === Object && 0 === Object.keys(o).length || "boolean" == typeof o) && (i = void 0), { route: r, params: i };
            }
            return {};
        }
        ...
        unregisterRoute(t) {
            ...
            if (e > -1) this.t.get(t.method).splice(e, 1);
    ...
    const u = { googleAnalytics: "googleAnalytics", precache: "precache-v2", prefix: "workbox", runtime: "runtime", suffix: "undefined" != typeof registration ? registration.scope : "" },
    ...
    async function m(t, e) {
        ...
        const i = t.clone(), r = { headers: new Headers(i.headers), status: i.status, statusText: i.statusText }, o = e ? e(r) : r, c = function() { if (void 0 === R) { const t = new Response(""); if ("body" in t) try { new Response(t.body), R = !0 } catch (t) { R = !1 } R = !1 } return R }() ? i.body : await i.blob();
    ...
    class b {
        ...
        async cacheMatch(t) {
            ...
            for (const t of this.iterateCallbacks("cachedResponseWillBeUsed")) s = await t({ cacheName: n, matchOptions: i, cachedResponse: s, request: r, event: this.event }) || void 0;
            return s;
        }
        ...
        async cachePut(t, e) {
            ...
            const { cacheName: a, matchOptions: h } = this.l,
                ...
                l = this.hasCallback("cacheDidUpdate") ? await async function(t, e, s, n) {
                    const i = v(e.url, s);
            ...
            for (const t of this.iterateCallbacks("cacheDidUpdate")) await t({ cacheName: a, oldResponse: l, newResponse: c.clone(), request: r, event: this.event });
            return!0;
        }
        ...
        *iterateCallbacks(t) {
        ...
        async v(t) {
            ...
            for (const t of this.iterateCallbacks("cacheWillUpdate"))
                if (e = await t({ request: this.request, response: e, event: this.event }) || void 0,
                    s = !0, !e) break;
    ...
    class C {
        ...
        async U(requestPromise, handler, request, event) {
            let response, error;
            try {
                response = await requestPromise;
            } catch (caughtError) {
                // Error handling can be more explicit here if needed
            }
            try {
    ...
    class E extends C {
        ...
        async O(request, handler) {
            const response = await handler.fetch(request);
            if (!await handler.cachePut(request, response.clone())) {
                throw new s('bad-precaching-response', { url: request.url, status: response.status });
            }
            return response;
        }
        ...
        async N() {
            ...
            if (0 === e) this.plugins.push(E.defaultPrecacheCacheabilityPlugin);
            else e > 1 && null !== t && this.plugins.splice(t, 1);
        }
    }
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                if ("string"!= typeof n && n.integrity) {
                    if (this.P.has(t) && this.P.get(t)!== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {url: i});
        ...
        install(t) {
            return d(t, async () => {
                ...
                for (const [e, s] of this.k) {
                    const n = this.P.get(s), i = this.K.get(e), r = new Request(e, {integrity: n, cache: i, credentials: "same-origin"});
    ...
    class k extends i {
        constructor(t, e) {
            super((({request: s})=>{const n = t.getURLsToCacheKeys(); for (const i of function*(t, {ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: s = "index.html", cleanURLs: n = !0, urlManipulation: i} = {}) {
    ...
    t.cleanupOutdatedCaches = function(){
        self.addEventListener("activate", (t => {
            const e = f();
            t.waitUntil((async function(t, e = "-precache-") {
